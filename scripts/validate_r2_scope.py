...
def validate(root: Path):
    ...
    if scope.get("active_work_id") != "aingurunuru" or scope.get("benchmark_range") != [1,2] or scope.get("stabilization_range") != [3,10]:
        errors.append("Aingurunuru benchmark/stabilization boundary drifted")
